...
if (isset($_POST['get_report'])) {
    ...
    $sel_query = "SELECT * FROM donations WHERE donation_date BETWEEN '$from' AND '$to'$condition";
...
<?php
           ...
           <center>   
        <img src="Logo/footer.jpeg" alt="" style="height:auto; width:100%; margin-top:500px;">
           </center>
