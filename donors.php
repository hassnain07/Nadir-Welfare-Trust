...
if (isset($_GET['action']) && $_GET['action'] == "delete_donor") {





    if ($_GET['donation_type'] == "items") {
      
      $dele_qry = mysqli_query($conn,"DELETE FROM item_donations WHERE donation_id = '".$_GET['donation_id']."'");

    }elseif ($_GET['donation_type'] == "cash") {

      $sel_cash_amount = mysqli_query($conn,"SELECT cash_amount FROM donations WHERE donation_id = '".$_GET['donation_id']."'");
      $cash_amount_arr = mysqli_fetch_array($sel_cash_amount);
      $upd_cash_table  = mysqli_query($conn,"UPDATE cash_donations SET
                           
                       donation_cash  = donation_cash - '".$cash_amount_arr['cash_amount']."'

      ");
    } 
    
    $del_qry = mysqli_query($conn,"DELETE FROM donations WHERE donation_id = '".$_GET['donation_id']."'");
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-hover">
                  ...
                  <tbody>
                    ...
                    <?php
                    $sql = "SELECT donations.*, donor_info.* FROM donations
                    INNER JOIN donor_info ON donations.donor_id = donor_info.donor_id WHERE donation_type = '".$_GET['type']."'";
                ...
                ?>
                    ...
                    <tr>
                      ...
                      <td>
                        <a href="donors.php?donor_id=<?php echo $donation_data['donor_id']?>&action=delete_donor&donation_type=<?php echo $donation_data['donation_type']?>"
              ...
              <div class="card-body">
                ...
                ?>
                    ...
                    <tr>
                      ...
                      <td>
                        <a href="donors.php?donation_id=<?php echo $donation_data['donation_id']?>&amp;action=delete_donor&amp;donation_type=<?php echo $donation_data['donation_type']?>"
                          title="Delete" class="btn" onclick="javascript:return confirm('Are you sure?')"><i
                            class="fa-solid fa-trash-can"></i></a>

                        <a href="#" title="Update" class="btn" data-toggle="modal"
                          data-target="#modal-lg<?php echo $donation_data['donation_id']?>"><i
                            class="fa-solid fa-pen-to-square"></i></a>
                        <a href="donation_details.php?donation_id=<?php echo $donation_data['donation_id']?>"
                          title="View Details" class="btn"><i class="fa-solid fa-rectangle-list"></i></a>
                        <a href="javascript:void(0);"
                          onclick="printDonation(<?php echo $donation_data['donation_id']?>);" title="View Details"
                          class="btn">
                          <i class="fa-solid fa-print"></i>
                        </a>
                      </td>
                    ...
                    $sel_upd_donation = mysqli_query($conn,"SELECT * FROM donations WHERE donation_id = '".$donation_data['donation_id']."'");
                    $upd_don_arr      = mysqli_fetch_array($sel_upd_donation);
                    ...
                    <div class="modal fade" id="modal-lg<?php echo $donation_data['donation_id']?>">
                      <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                          <div class="modal-header">
                            <h4 class="modal-title">Update Donor</h4>
                                ...
                                <div class="col-md-12">
                                  ...
                                  <div class="row">
                                    <div class="col-md-2">
                                      <div class="icheck-primary d-inline">
                                        <?php 
        if ($upd_don_arr['donation_type'] == "cash") {
    ...
    ?>
                                    ...
                                    <div class="col-md-2">
                                      <div class="icheck-primary d-inline">
                                        ...
                                        <?php 
        if ($upd_don_arr['donation_type'] == "items") {
                                  ...
                                  <div class="col-md-12">
                                    <div class="form-group">
                                      ...
                                      <div class="input-group">
                                        ...
                                        <input type="number" class="form-control cash_input" name="cash_amount"
                                          value="<?php echo $upd_don_arr['cash_amount']?>"
                                          placeholder="Enter Cash Amount">
                                      </div>
                                    </div>
                                  </div>
                                      ...
                                      <div class="col-md-6">
                                        <div class="form-group">
                                          ...
                                          <div class="input-group">
                                            ...
                                            <input type="text" class="form-control item_inputs" name="item_name"
                                              value="<?php echo $upd_don_arr['item_name']?>"
                                              placeholder="Enter Item Name">
                                          </div>
                                        </div>
                                      </div>
                                      <div class="col-md-6">
                                        <div class="form-group">
                                          ...
                                          <div class="input-group">
                                            ...
                                            <input type="number" class="form-control item_inputs" name="item_quantity"
                                              value="<?php echo $upd_don_arr['item_quantity']?>"
                                              placeholder="Enter Item Quantity">
                                          </div>
                                        </div>
                                      </div>
