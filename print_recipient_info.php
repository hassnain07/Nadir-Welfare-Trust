...
<div class="row">
   ...
   <center>
    <?php 
    $sel_common_info = mysqli_query($conn, "SELECT donated_items.*, recipient_info.* 
    FROM donated_items
    INNER JOIN recipient_info ON donated_items.recipient_id = recipient_info.recipient_id 
    WHERE donated_items.recipient_id = '$don_id'");

    $print_info_arr  = mysqli_fetch_array($sel_common_info);
    ...
    ?>
           ...
           <table width="800px" cellpadding="10px" >
            <tr align="center" >
                <td><b>Donor Name: </b> <?php echo $print_info_arr['recipient_name']?></td>
                <td><b>Donor Phone Number: </b> <?php echo $print_info_arr['recipient_phone']?></td>
            </tr>
            
            <tr align="center">
                <td><b>Donor CNIC: </b> <?php echo $print_info_arr['recipient_cnic']?></td>
                <td><b>Donation Date: </b> <?php echo $print_info_arr['donation_date']?></td>
            </tr>
            <tr align="center">
                <td rowspan="2"><b>Donor Address: </b></td>
                <td><?php echo $print_info_arr['recipient_address']?></td>
            </tr>
           </table>
