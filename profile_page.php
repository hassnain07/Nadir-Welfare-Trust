...
if (isset($_POST['update_info'])) {
    ...
    $update_info  = mysqli_query($conn,"UPDATE admins SET
...
<body class="hold-transition sidebar-mini layout-fixed">
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      <?php
      $sel_admin_data = mysqli_query($conn,"SELECT * FROM admins");
      $admin_arr      = mysqli_fetch_array($sel_admin_data);
            ...
            <div class="col-md-4">
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" class="form-control" placeholder="Admin Name" name="admin_name" value="<?php echo $admin_arr['admin_name']?>" required>
                  </div>  
                </div>
              </div>
              ...
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" class="form-control" placeholder="Password" name="password" value="<?php echo $admin_arr['admin_password']?>" required>
                  </div>  
                </div>
              </div>
