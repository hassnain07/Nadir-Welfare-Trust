    ...
    <section class="content">
      <div class="container-fluid">
        <div class="row">
          <div class="col-md-12">
          <?php
                $selecting_don_details  = mysqli_query($conn, "SELECT * FROM donated_items WHERE donation_id = '".$_GET['recipient_id']."'");
                $donation_details_arr   = mysqli_fetch_array($selecting_don_details);

                $selecting_donor_details  = mysqli_query($conn, "SELECT * FROM recipient_info WHERE recipient_id = '".$donation_details_arr['recipient_id']."'");
            ...
            <div class="card card-primary card-outline">
              <div class="card-body box-profile">
                ...
                <h3 class="profile-username text-center"><?php echo ucfirst($donor_details_arr['recipient_name'])?></h3>

                <p class="text-muted text-center"><?php echo ucfirst($donor_details_arr['recipient_address'])?></p>
                ...
                <ul class="list-group list-group-unbordered mb-3">
                  <li class="list-group-item">
                    <div class="row">
                        <div class="col-md-6">
                        <b>Recipient Phone Number :&nbsp;&nbsp;</b><?php echo $donor_details_arr['recipient_phone']?>
                        </div>
                        <div class="col-md-6">
                        <b>Recipient CNIC :&nbsp;&nbsp;</b> <?php echo $donor_details_arr['recipient_cnic']?>
                        </div>
                    </div>
                  </li>
                  <?php
